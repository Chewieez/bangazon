...
namespace BangazonAPI
{
	public static class SeedData
	{
		public static void Initialize(IServiceProvider serviceProvider)
		{
			...
			{
				context.TrainingProgram.Add(new TrainingProgram { Name = "AngularJS Course", StartDate =  Convert.ToDateTime("02/12/2018"), EndDate = Convert.ToDateTime("02/16/2018"), MaxAttendance = 25 });
